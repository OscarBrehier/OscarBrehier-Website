...
const Navigation = () => {
    ...
    const Elements = () => {
        ...
        pages.forEach(el => {
            ...
            if(active == el) { elements.push(<div className={style} style={{color: 'white'}}><a href="">{el}</a></div>); }
    ...
    return ( 
        ...
        <div className="h-[12vh] w-full flex items-center justify-center absolute z-10">
            <div className="
